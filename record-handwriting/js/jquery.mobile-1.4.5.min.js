...
//# sourceMappingURL=jquery.mobile-1.4.5.min.map</div></=></div></e.diff)&&(j[a.snd]-=d.arhalf[a.dimkey]+f[a.prop]+d.contentbox[a.snd],e={dir:b,diff:h,result:f,posprop:a.prop,posval:j[a.snd]}),e)},_getplacementstate:function(a){var></div></div></f-i||h.pagex></div></div></=0&&(h="ui-li-static></0)&&(l=this._getchildrenbytagname(g[0],"a","a"),m="list-divider"===b(g[0],"role"),p=g.attr("value"),i=b(g[0],"theme"),l.length&&l[0].classname.search(></=5)for(d></div></div></div></0&&(j="#"+j),t={transition:h.transition,title:p,pageurl:k,role:h.role},h.changehash!==!1&&a.mobile.hashlisteningenabled?a.mobile.navigate(this.window[0].encodeuri(j),t,!0):b[0]!==a.mobile.firstpage[0]&&a.mobile.navigate.history.add(j,t)),c.title=p,a.mobile.activepage=b,this.activepage=b,h.reverse=h.reverse||0></[^></a></b&&c.css("min-height",b-(f-e))},loading:function(){var></f.length;e++)a.options[f[e][0]]&&f[e][1].apply(a.element,c)}}}(a),function(a,b){var></a></a>